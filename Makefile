...
CFLAGS = -Wall -O3
CPPFLAGS = -I.
LDFLAGS = -lm -lassimp -lSDL2_image -lSDL2_ttf -lfftw3



# définition des fichiers et dossiers
PROGNAME = StarshipTrip
VERSION = 1.3
distdir = $(PROGNAME)-$(VERSION)
HEADERS = audioHelper.h assimp.h assimp2.h animations.h 
SOURCES = audioHelper.c assimp.c assimp2.c animations.c window.c falcon.c meteorite.c credits.c Titre.c cercle.c tatooine.c
OBJ = $(SOURCES:.c=.o)
DOXYFILE = documentation/Doxyfile
EXTRAFILES = COPYING $(wildcard shaders/*.?s images/*.jpg)
