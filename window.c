...
static GL4DHanime _animations[] = {
  { 10000, Titre, NULL, NULL },
  { 2000, Titre, credits, fondu },
  { 15000, credits, NULL, NULL },
  { 3000, credits, falcon, transition_01 },
  { 10000, falcon, NULL, NULL },
  { 3000, falcon, cercle, transition_01 },
  { 5000, cercle, NULL, NULL },
  { 3000, cercle, meteorite, transition_01 },
  { 10500, meteorite, NULL, NULL },
  { 3000, meteorite, tatooine, fondui },
  { 15000, tatooine, NULL, NULL },
...
int main(int argc, char ** argv) {
  ...
  gl4duwSetGLAttributes(3, 2, GL4DW_CONTEXT_PROFILE_CORE, 1, 16);
  if(!gl4duwCreateWindow(argc, argv, "Starship Trip", 
			 SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, 
			 _dim[0], _dim[1],
			 GL4DW_RESIZABLE | GL4DW_SHOWN /* | GL4DW_FULLSCREEN */))
    return 1;
  init();
  atexit(quit);
